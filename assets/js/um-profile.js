jQuery(document).ready(function() {
	...
	jQuery(document.body).on('click', '.um-reset-cover-photo', function(e){
		...
		jQuery('.um-cover-e').html('<a href="javascript:void(0);" class="um-cover-add" style="height: 370px;"><span class="um-cover-add-i"><i class="fas fa-plus um-tip-n" original-title="Upload a cover photo"></i></span></a>');
