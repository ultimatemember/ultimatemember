...
b&&jQuery(this).addClass("disabled")});jQuery(document).on("click",".um-field-group-cancel",function(a){a.preventDefault();a=jQuery(this).parents(".um-field-group");var b=a.data("max_entries");a.find(".um-field-group-body").length>1?jQuery(this).parents(".um-field-group-body").remove():jQuery(this).parents(".um-field-group-body").hide();b>0&&a.find(".um-field-group-body").length<b&&a.find(".um-field-group-head").removeClass("disabled");return false});jQuery(".um-members").each(function(){UM_Member_Grid(jQuery(this))});
jQuery(".um-member-meta-main").each(function(){jQuery(this).find(".um-member-metaline").length==0&&jQuery(this).remove()});jQuery(".um-member-connect").each(function(){jQuery(this).find("a").length==0&&jQuery(this).remove()});jQuery(document).on("click",".um-member-more a",function(a){a.preventDefault();a=jQuery(this).parents(".um-member");var b=jQuery(this).parents(".um-members");a.find(".um-member-more").hide();a.find(".um-member-meta").slideDown(function(){UM_Member_Grid(b)});a.find(".um-member-less").fadeIn();
setTimeout(function(){UM_Member_Grid(b)},100);return false});jQuery(document).on("click",".um-member-less a",function(a){a.preventDefault();var b=jQuery(this).parents(".um-member"),c=jQuery(this).parents(".um-members");b.find(".um-member-less").hide();b.find(".um-member-meta").slideUp(function(){b.find(".um-member-more").fadeIn();UM_Member_Grid(c)});return false});jQuery(document).on("click",".um-do-search",function(a){a.preventDefault();jQuery(this).parents("form").submit();return false});jQuery(document).on("click",
