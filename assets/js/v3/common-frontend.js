...
UM.frontend = {
	...
	slider: {
		controlFromSlider: function(fromSlider, toSlider/*, fromInput*/) {
			...
			UM.frontend.slider.fillSlider(fromSlider, toSlider, um_common_variables.colors.gray200, um_common_variables.colors.primary600bg, toSlider);
			if (from > to) {
				fromSlider.value = to;
				// fromInput.value = to;
			} else {
			...
			jQuery('.um-range-container').each( function() {
				...
				if ( controlSlider ) {
					controlSlider.addEventListener('mouseover', function() {
						UM.frontend.slider.fillSlider(fromSlider, toSlider, um_common_variables.colors.gray300, um_common_variables.colors.primary700bg, toSlider);
					});
