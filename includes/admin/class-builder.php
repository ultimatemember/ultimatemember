...
if ( ! class_exists( 'um\admin\Builder' ) ) {
	...
	class Builder {
		 ...
		 * @param $edit_array
		 */
		public function add_conditional_support( $form_id, $field_args, $in_edit, $edit_array ) {
		 ...
		 * @return string
		 */
		public function get_fields_in_subrow( $row_fields, $subrow_id ) {
		 ...
		 * @param $metabox
		 */
		public function modal_footer( $arg2, $args, $metabox ) {
			/**
			 * UM hook
			 *
			 * @type action
