...
<div id="UM_add_field" style="display:none">
	...
	<form action="" method="post" class="um_add_field">
		...
		<div class="um-admin-modal-head">
			<h3><?php esc_html_e( 'Add a New Field', 'ultimate-member' ); ?></h3>
		</div>
		...
		<div class="um-admin-modal-foot">
			...
			<a href="javascript:void(0);" data-modal="UM_fields" class="button"><?php esc_html_e( 'Cancel', 'ultimate-member' ); ?></a>
		</div>
