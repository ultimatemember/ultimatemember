...
<p>
	<?php printf( __( '%s provides you with forms for user registration, login and profiles.', 'ultimate-member' ), UM_PLUGIN_NAME ); ?>
</p>
<p>
...
<p>
	<?php printf( __( '%s does not send any user data outside of your site by default.', 'ultimate-member' ), UM_PLUGIN_NAME ); ?>
</p>
<p>
