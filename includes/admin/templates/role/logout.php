		...
		array(
			...
			'fields'    => array(
				array(
					...
					'description' => __( 'Select what happens when a user with this role logouts of your site', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Set a url to redirect this user role to after they logout from site', 'ultimate-member' ),
