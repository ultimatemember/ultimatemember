		...
		array(
			...
			'fields'    => array(
				array(
					...
					'description' => __( 'Allow this user role to view your site\'s homepage', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Set a url to redirect this user role to if they try to view your site\'s homepage', 'ultimate-member' ),
