	...
	UM()->admin_forms( array(
		...
		'fields'    => array(
			array(
				...
				'description'   => __( 'The core admin role must always have access to wp-admin / WordPress backend', 'ultimate-member' ),
			...
			array(
				...
				'description'   => __( 'Mark this option if you need to hide the adminbar on frontend for this role', 'ultimate-member' ),
			...
			array(
				...
				'description'   => __( 'Allow this role to edit accounts of other members', 'ultimate-member' ),
			...
			array(
				...
				'description'       => __( 'Which roles that role can edit, choose none to allow role to edit all member roles', 'ultimate-member' ),
