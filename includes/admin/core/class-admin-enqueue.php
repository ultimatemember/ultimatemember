...
if ( ! class_exists( 'um\admin\core\Admin_Enqueue' ) ) {
	...
	class Admin_Enqueue {
		...
		function enqueue_frontend_preview_assets() {
			...
			wp_register_script( 'select2', $this->front_js_baseurl . 'select2/select2.full' . $this->suffix . '.js', array( 'jquery', 'jquery-masonry' ), ultimatemember_version, true );
			...
			wp_register_style( 'select2', $this->front_css_baseurl . 'select2/select2' . $this->suffix . '.css', array(), ultimatemember_version );
