jQuery(document).ready(function() {
	jQuery(document.body).on("click", "#um_add_review_love", function(e) {
		jQuery(this)
			.parents("#um_start_review_notice")
			.hide();
	...
	jQuery(document.body).on(
		"click",
		".um-admin-notice.is-dismissible .notice-dismiss",
		function(e) {
			var notice_key = jQuery(this)
				.parents(".um-admin-notice")
				.data("key");
			...
			wp.ajax.send("um_dismiss_notice", {
				...
				success: function(data) {
					// checks if success response is malformed for fallback purpose
