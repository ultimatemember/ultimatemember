		...
		array(
			...
			'fields'    => array(
				array(
					...
					'description' => __( 'If turned on, member results will only appear after search/filter is performed', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Use this setting to control the maximum number of profiles to appear in this directory. Leave blank to disable this limit', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Number of profiles to appear on page for standard users', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Number of profiles to appear on page for mobile users', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Customize the search result text. E.g. Found 3,000 Members. Leave this blank to not show result text. You could use {total_users} placeholder for getting users count.', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'Same as above but in case of 1 user found only. You could use {total_users} placeholder for getting users count.', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'This is the text that is displayed if no users are found during a search', 'ultimate-member' ),
