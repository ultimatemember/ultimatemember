		...
		array(
			...
			'fields'    => array(
				array(
					...
					'description' => __( 'If turned on, users will be able to search members in this directory', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'If you want to allow specific user roles to be able to search only', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'If turned on, users will be able to filter members in this directory', 'ultimate-member' ),
				...
				array(
					...
					'description' => __( 'If you want to allow specific user roles to be able to filter only', 'ultimate-member' ),
				...
				array(
					...
					'conditional'         => array( '_um_filters', '=', 1 ),
					'options'             => UM()->module( 'member-directory' )->config()->get( 'filter_fields' ),
				...
				array(
					...
					'description'         => __( 'Limit which users appear in the member directory e.g only display users from USA', 'ultimate-member' ),
