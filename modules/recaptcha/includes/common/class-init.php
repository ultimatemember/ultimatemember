...
class Init {
	...
	public function wp_login_form() {
		if ( empty( UM()->classes['umm\recaptcha\includes\common\wp_login_form'] ) ) {
			UM()->classes['umm\recaptcha\includes\common\wp_login_form'] = new WP_Login_Form();
		}
		return UM()->classes['umm\recaptcha\includes\common\wp_login_form'];
	}
