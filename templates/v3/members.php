...
foreach ( $args['view_types'] as $type ) {
	...
	UM()->get_template( 'v3/members-' . $type . '.php', $basename, $args, true );
}
UM()->get_template( 'v3/members-header.php', '', $args, true );
UM()->get_template( 'v3/members-pagination.php', '', $args, true );
